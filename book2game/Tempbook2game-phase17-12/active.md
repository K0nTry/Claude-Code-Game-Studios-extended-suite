...
- [x] G1: PDF/EPUB/DOCX → full_text.md — CHECK: python parse_book.py — EXPECT: FULL_TEXT_OK — EVIDENCE: 105 chars, 19 words
...
- [ ] G6: Resume — CHECK: active.md exists — EXPECT: RESUME_OK — EVIDENCE: 2026-09-14T22:45:33.486298

## Session Log

- 2026-09-14 22:45 — parse_book.py OK — minimal.pdf → 1 chunks
