# Context Boundary — creative-director

## This projection contains

Book-derived analysis data only:
- **Canon:** entities.json, relationships.json, world-boundaries.json, world-glossary.json, entity-aliases.json
- **Derived:** executive_audit_report.json, tension-pacing-curve.json, expansion-grammar.json, faction-dynamics.json
