# Game Concept — sample_real_book

> Πηγή: sample_real_book  | Λέξεις: 104 | Ημερομηνία: 2026-09-14

## 1. Elevator Pitch

> _Συμπληρώνεται από Claude ανάλυση — μία παράγραφος που πουλάει το παιχνίδι σε 30 δευτερόλεπτα._

Βασισμένο στο βιβλίο «sample_real_book». Το παιχνίδι μεταφέρει τον κόσμο, τους χαρακτήρες και την κεντρική σύγκρουση του βιβλίου σε διαδραστική εμπειρία.
...
- **Fantasy:** sample_real_book — γίνε ο πρωταγωνιστής
