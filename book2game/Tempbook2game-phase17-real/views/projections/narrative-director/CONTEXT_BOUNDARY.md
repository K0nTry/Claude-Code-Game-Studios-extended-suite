# Context Boundary — narrative-director

## This projection contains

Book-derived analysis data only:
- **Canon:** entities.json, relationships.json, world-glossary.json, entity-aliases.json
- **Derived:** character-psychology.json, voice-fingerprints.json, choice-tree.json, expansion-grammar.json
