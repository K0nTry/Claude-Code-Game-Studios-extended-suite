# Context Boundary — world-builder

## This projection contains

Book-derived analysis data only:
- **Canon:** entities.json, relationships.json, world-boundaries.json, world-glossary.json
- **Derived:** relationship-matrix.json, information-spread-graph.json, faction-dynamics.json, expansion-grammar.json
