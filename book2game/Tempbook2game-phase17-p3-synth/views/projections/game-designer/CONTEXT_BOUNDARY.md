# Context Boundary — game-designer

## This projection contains

Book-derived analysis data only:
- **Canon:** entities.json, world-boundaries.json
- **Derived:** tension-pacing-curve.json, economy-formulas.md, progression-gini.json, dda-rules.json, faction-dynamics.json
